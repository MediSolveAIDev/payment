...
| `services` | UPDATE | 키 재발급, IP 수정, 취소정책 수정, 상태 변경, 대표 담당자 변경 |
...
### `services` 테이블 주요 컬럼 (`app/models/service.py:12-33`)
...
### 15-7. 서비스 등록/키 관련 감사 로그 action 목록
