...
> **참고**: 문자열 데이터 타입의 [하위 포맷](https://swagger.io/docs/specification/data-models/data-types/#format)과 숫자 데이터 타입 `integer`와 `number`에서 지원하는 [하위 포맷](https://swagger.io/docs/specification/data-models/data-types/#numbers)은 토스페이먼츠에서 지원하는 타입만 소개합니다.
