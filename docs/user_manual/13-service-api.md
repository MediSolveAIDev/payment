...
| 필드 | 타입 | 제약 | 설명 |
|------|------|------|------|
| `external_user_id` | string | 이메일, 1–255자 | 외부 서비스 측 사용자 식별자(이메일·소문자 정규화) |
...
| 필드 | 타입 | 제약 | 설명 |
|------|------|------|------|
| `external_user_id` | string | 이메일, 1–255자 | 외부 서비스 측 사용자 식별자(이메일·소문자 정규화, 서비스+사용자 당 구독 1개 기준) |
