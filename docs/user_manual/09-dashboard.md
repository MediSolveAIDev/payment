...
> 함께 보기: [구독 관리](03-admin-subscription.md) · [일반결제·환불](05-admin-payment-refund.md) · [관리자 콘솔 사용하기](01-admin-console.md)
...
대시보드의 서비스별 표는 빠른 요약용입니다. 기간을 직접 정하고, 서비스·요금제로 더 자세히 거르고, **엑셀로 내려받으려면 정산 화면**을 이용하세요. 정산 화면도 같은 계산 규칙(순매출 = 총매출 − 환불, 부분취소 포함)을 사용합니다.

> 함께 보기: 기간 선택·요금제 필터·엑셀 다운로드가 필요하면 [일반결제·환불](05-admin-payment-refund.md) 흐름과 정산 화면을 참고하세요.
...
> 함께 보기: 요금제를 만들고 가격·주기·할인을 설정하려면 [요금제 관리](04-admin-plan.md)를 참고하세요.
...
> 함께 보기: 구독 상태별 운영(강제취소·연장·재결제)은 [구독 관리](03-admin-subscription.md), 결제·환불 상세는 [일반결제·환불](05-admin-payment-refund.md)에서 이어집니다.
